...
# from pipelines.processing import IngestionConfig, whitelist_str_as_list
...
#         whitelist = env_var_or_default("WHITELISTED_EXTENSIONS", "'[\"py\"]'")
#         blacklist = env_var_or_default("BLACKLISTED_FILES", "[]")
...
#     def get_app_config(self) -> IngestionConfig:
#         """
