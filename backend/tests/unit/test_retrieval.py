...
#         return EmbeddedChunk(embeddings)
...
#         query = InputQuery(query="query")
#         response = ""
#         async for chunk in rag_service.rag_stream(query, 1, id):
#             response += chunk
...
#             async for _ in rag_service.rag_stream(query, 1, "foo"):
#                 pass
