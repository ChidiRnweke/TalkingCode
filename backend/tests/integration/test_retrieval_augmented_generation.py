...
#         response = ""
#         async for chunk in rag.rag_stream(input, 1, "test"):
#             response += chunk
...
#         id = "test"
#         resp1 = ""
#         async for chunk in rag.rag_stream(input, 1, id):
#             resp1 += chunk
...
#         )
#         obtained = ""
#         async for chunk in rag.rag_stream(second_query, 1, id):
#             obtained += chunk
...
#         for i in range(10):
#             id = "spend"
#             async for _ in rag.rag_stream(input, 1, id):
#                 pass
#         obtained = await rag.remaining_spend()
#         assert obtained.remaining_spend == expected
...
#         async for _ in rag.rag_stream(input, 1, "high spend"):
#             pass
