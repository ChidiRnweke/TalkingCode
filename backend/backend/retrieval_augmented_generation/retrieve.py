...
from typing import AsyncGenerator, Optional, Protocol, Self, cast as type_cast
...
class OpenAIGenerationService(GenerationService):
    ...
    def _create_model_input(
        ...
        model_input = type_cast(list[ChatCompletionMessageParam], model_input)
        return model_input


def add_sources(retrieved: list[RetrievedContext]) -> str:
    """
