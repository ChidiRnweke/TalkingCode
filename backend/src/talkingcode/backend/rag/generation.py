...
from typing import TYPE_CHECKING, AsyncGenerator, Optional, Protocol, cast
...
class GenerationService(Protocol):
    ...
    def augmented_generation(
        ...
        Returns:
            AsyncGenerator[str, None]: The response generated by the model.
        """
        ...
    ...
    async def augmented_generation(
        ...
        with map_errors():
            ...
            async for chunk in stream:
                chunk, usage = self._parse_chunk(chunk, sources)
                if usage:
